...
var resizePizzas = function(size) {
  ...
  //removed determineDx, changed sizeSwitcher to changePizzaSizes
...
// Generates the sliding pizzas when the page loads. Got rid of querySelector, reedited to shorten appendChild
